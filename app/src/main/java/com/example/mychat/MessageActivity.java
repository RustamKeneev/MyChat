...
public class MessageActivity extends AppCompatActivity {
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this,"Вы не можете пустое сообщение",Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user.getImageURL().equals("default")){
                    profile_image.setImageResource(R.mipmap.ic_launcher_user);
                }else {
    ...
    private void sendMessage(String sender, String receiver, String message, final String userid){
